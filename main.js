    ...
    static refresh_books(){
        ...
        this.library.forEach(book => {
            ...
            del_btn.addEventListener("click", ()=>{
                this.library = this.library.filter(book=> book.title != book_h2.textContent)
                this.refresh_books()
            })
